...
/* harmony default export */ const editor = (class {
  constructor() {
...
if ('serviceWorker' in navigator) {
  ...
  const workboxSW = new v('/src-sw.js');
  workboxSW.register();
} else {
